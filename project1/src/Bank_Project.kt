fun main() {
    ...
    //Interface Statements to be printed
    ...
    while (accountType == "") {
        ...
        when (userChoice) { //for user choice
            1 -> accountType = "debit"
    ...
    var accountBalance = (0..1000).random()					//to chech the current balance
    println("The current balance is ${accountBalance} dollars.")
    val money = (0..1000).random()							//the amount of money deposited/withdrawn
    ...
    //handles withdrawn/debit operations
